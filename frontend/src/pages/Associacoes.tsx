...
export default function Associacoes() {
  ...
  const loadAssociacoes = useCallback(async (produtoId: number) => {
    try {
      ...
      setToast({ message: 'Erro ao carregar associacoes.', type: 'error' });
    }
  }, []);
  ...
  return (
    <div>
      ...
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Associacao de Fornecedor a Produto</h1>
        ...
        <div className="lg:col-span-2">
          {!selectedProduto ? (
            <div className="bg-white rounded-xl shadow-md p-8 text-center text-gray-500">
              ...
              <p>Selecione um produto para gerenciar suas associacoes com fornecedores.</p>
            </div>
          ) : (
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-xs font-medium text-gray-500 uppercase">Codigo de Barras</label>
                    <p className="text-sm text-gray-800">{selectedProduto.codigo_barras || '-'}</p>
                  </div>
                  <div className="md:col-span-2">
                    <label className="text-xs font-medium text-gray-500 uppercase">Descricao</label>
                    ...
                    <table className="w-full">
                      <thead className="bg-gray-50 border-b">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-right text-xs font-semibold text-gray-600 uppercase">Acao</th>
                        </tr>
                      </thead>
